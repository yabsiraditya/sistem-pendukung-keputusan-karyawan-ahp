...
public class PanelPeringkat extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btncalculate.setFillClick(new java.awt.Color(55, 36, 24));
        btncalculate.setFillOriginal(new java.awt.Color(78, 51, 34));
        btncalculate.setFillOver(new java.awt.Color(103, 77, 61));
