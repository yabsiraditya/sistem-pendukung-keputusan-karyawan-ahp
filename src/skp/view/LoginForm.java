...
public class LoginForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        bgloginpanel.setBackground(new java.awt.Color(78, 51, 34));
        ...
        btnlogin.setBackground(new java.awt.Color(78, 51, 34));
        btnlogin.setIcon(new javax.swing.ImageIcon(getClass().getResource("/skp/assets/login.png"))); // NOI18N
        btnlogin.setText("Login");
        btnlogin.setFillClick(new java.awt.Color(55, 36, 24));
        btnlogin.setFillOriginal(new java.awt.Color(78, 51, 34));
        btnlogin.setFillOver(new java.awt.Color(103, 77, 61));
